...
var exports = module.exports = function(opt, callback) {
  ...
  Promise.resolve()
    .then(function () {
      ...
      if (!hookLoaded) {
        hookLoaded = true;
        return fis.util.pipe('hook', function(processor, settings) {
          return processor(fis, settings);
        });
      }
    })
    .then(function () {
      ...
      return promise.then(promiseFinally).catch(promiseFinally);
    ...
    .then(function () {
      ...
      var cb = function(packager, settings, key, type) {
        ...
        return Promise.resolve().then(function () {
          return packager(ret, conf, settings, opt);
        }).then(function () {
      ...
      ['prepackager', 'packager', 'spriter', 'postpackager'].forEach(function(name) {
        ...
        promise = promise.then(function () {
          return fis.util.pipe(name, cb, opt[name]);
        });
      });
